    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class='box box-primary'>
                ...
                <div class='box-body'>
                    <form method='POST' action='{{ route('core_cities.store') }}'>
                        @csrf
                        <div class='row form-group'>
                            <div class='col-md-12'>
                                ...
                                <div class='col-md-3'>
                                    ...
                                    <input class='form-control' name='zip' class='form-control' value='{{old('zip')}}'>
                                </div>
                                <div class='col-md-3'>
                                    ...
                                    <select name='core_province_id' class='form-control' style='width: 100%'>
                                        ...
                                        <option value='{{$coreProvince->id}}' {{ old('core_province_id')==$coreProvince->id ? 'selected' : '' }}>
                                            {{$coreProvince->name}}
                                        </option>
                                        @endforeach
                                    </select>
