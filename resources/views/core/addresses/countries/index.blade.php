        ...
        <div class='col-md-12'>
            <div class='box box-primary'>
                <div class='box-header with-border'>
                    <h3 id="entityTitle">Elenco delle nazioni</h3>
                    @if(in_array('A', $chars))
                    <a class='btn btn-primary' href='{{ route('core_countries.create') }}'>
                        <i class='fas fa-plus'></i> Nuova Nazione
                    </a>
                    @endif
                </div>
                <div class='box-body'>
...
@if (in_array('D', $chars))
<x-core.modals.modal-delete-item prefix='coreCountry' action='eliminare la nazione' url='core_countries'
    tableId='table' />
@endif
@endsection
