        ...
        <div class='col-md-12'>
            <div class='box box-primary'>
                <div class='box-header with-border'>
                    <h3 id="entityTitle">Elenco delle province</h3>
                    @if(in_array('A', $chars))
                    <a class='btn btn-primary' href='{{ route('core_provinces.create') }}'>
                        <i class='fas fa-plus'></i> Nuova provincia
                    </a>
                    @endif
                </div>
                <div class='box-body'>
...
@if (in_array('D', $chars))
<x-core.modals.modal-delete-item prefix='coreProvince' action='eliminare la provincia' url='core_provinces' tableId='table' />
@endif
