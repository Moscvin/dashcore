        ...
        <div class='col-md-6'>
            <div class='box box-primary'>
                <div class='box-header with-border'>
                    <h3 id="entityTitle">Elenco dei specialization</h3>

                    @if (in_array('A', $chars))
                    <a href='{{ route('core_specialization.create') }}' class='btn btn-primary'>
                        <i class='fas fa-plus'></i> Nuovo Specialization
                    </a>
                    @endif
                </div>
                ...
                <div class='box-body'>
                    <div class='table-responsive'>
                        <table class='table table-responsive table-bordered' id='table'>
                            ...
                            <tbody>
                                @foreach($coreSpecializations as $coreSpecialization)
                                <tr>
                                    <td>{{ $coreSpecialization->specialization_name }}</td>
                                    @if (in_array('E', $chars))
                                    <td>
                                        <a href='{{ route('core_specialization.edit', $coreSpecialization->id) }}'
                                    ...
                                    @if (in_array('D', $chars))
                                    <td>
                                        <button onclick='coreSpecializationDeleteItem(this)' data-id='{{ $coreSpecialization->id }}'
...
@if (in_array('D', $chars))
<x-core.modals.modal-delete-item prefix='coreSpecialization' action='eliminare il group' url='core_specialization' tableId='table' />
@endif
@endsection
