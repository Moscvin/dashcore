        ...
        <div class='col-md-6'>
            <div class='box box-primary'>
                <div class='box-header with-border'>
                    <h3 id="entityTitle">Elenco dei gruppi</h3>

                    @if (in_array('A', $chars))
                    <a href='{{ route('core_groups.create') }}' class='btn btn-primary'>
                    ...
                    <div class='table-responsive'>
                        <table class='table table-responsive table-bordered' id='table'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $coreGroup->name }}</td>
                                    @if (in_array('E', $chars))
                                    <td>
                                        <a href='{{ route('core_groups.edit', $coreGroup->id) }}'
                                    ...
                                    @if (in_array('D', $chars))
                                    <td>
                                        <button onclick='coreGroupDeleteItem(this)' data-id='{{ $coreGroup->id }}'
...
@if (in_array('D', $chars))
<x-core.modals.modal-delete-item prefix='coreGroup' action='eliminare il group' url='core_groups' tableId='table' />
@endif
@endsection
