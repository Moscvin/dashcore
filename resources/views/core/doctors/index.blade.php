        ...
        <div class='col-md-6'>
            <div class='box box-primary'>
                <div class='box-header with-border'>
                    <h3 id="entityTitle">Elenco dei doctor</h3>

                    @if (in_array('A', $chars))
                    <a href='{{ route('core_doctors.create') }}' class='btn btn-primary'>
                        <i class='fas fa-plus'></i> Nuovo Doctor
                    </a>
                    @endif
                </div>
                        ...
                        <table class='table table-responsive table-bordered' id='table'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if (in_array('D', $chars))
                                    <td>
                                        <button onclick='coreDoctorDeleteItem(this)' data-id='{{ $coreDoctor->id }}'
...
@if (in_array('D', $chars))
<x-core.modals.modal-delete-item prefix='coreDoctor' action='eliminare il doctor' url='core_doctors' tableId='table' />
@endif
@endsection
