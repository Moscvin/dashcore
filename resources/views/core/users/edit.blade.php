    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form method="POST" action="{{ route('core_users.update', $coreUser) }}">
                        @method("PATCH")
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="username"
                                        value="{{ old('username', $coreUser->username) }}" />
                                </div>
                                <div class="col-md-3">
                                    <label class="col-form-label required">Email:</label>
                                    <input class="form-control" name="email"
                                        value="{{ old('email', $coreUser->email) }}" />
                                </div>
                                <div class="col-md-3">
                                    <label class="col-form-label required">Cognome:</label>
                                    <input class="form-control" name="surname"
                                        value="{{ old('surname', $coreUser->surname) }}" />
                                </div>
                                <div class="col-md-3">
                                    <label class="col-form-label" for="name">Nome:</label>
                                    <input class="form-control" name="name"
                                        value="{{ old('name', $coreUser->name) }}" />
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="core_group_id" class="form-control" style="width: 100% !important">
                                        ...
                                        <option value="{{ $coreGroup->id }}" {{ old('core_group_id', $coreUser->core_group_id) == $coreGroup->id ? 'selected' : '' }}>
                                            {{ $coreGroup->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control" name="active">
                                        <option value="0" {{ old('active', $coreUser->active) == 0 ? 'selected' : ''
                                            }}>No</option>
                                        <option value="1" {{ old('active', $coreUser->active) == 1 ? 'selected' : ''
                                            }}>Si</option>
                                    </select>
                                </div>
                            </div>
