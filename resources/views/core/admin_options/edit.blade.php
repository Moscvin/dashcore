    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class='box box-primary'>
                ...
                <div class='box-body'>
                    <form method='POST' action='{{ route('core_admin_options.update', $coreAdminOption) }}'>
                        @method('PATCH')
                        @csrf
                            ...
                            <div class='col-md-12'>
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="description"
                                        value="{{ old('description', $coreAdminOption->description) }}" />
                                </div>
                                <div class="col-md-3">
                                    <label class="col-form-label required">Valore:</label>
                                    <input class="form-control" name="value"
                                        value="{{ old('value', $coreAdminOption->value) }}" />
                                </div>
                            </div>
                        </div>
